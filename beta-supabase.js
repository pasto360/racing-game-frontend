...
const BetaModule = {
    ...
    // Carica circuiti (hardcoded - dati completi)
    async loadCircuits() {
        ...
        this.circuits = [
            {
                ...
                elevation: "high",
                bumps: 3,
                description: "Circuito leggendario con Eau Rouge. Richiede coraggio e setup bilanciato."
            },
            {
                id: "monaco",
                name: "Monte Carlo",
                ...
                elevation: "medium",
                bumps: 1,
                description: "Circuito cittadino strettissimo. Massima precisione e grip richiesti."
            },
            {
                id: "monza",
                ...
                elevation: "low",
                bumps: 0,
                description: "Tempio della velocità. Bassa deportanza e rapporti lunghi dominano."
            },
            {
                id: "silverstone",
                ...
                elevation: "low",
                bumps: 1,
                description: "Mix perfetto di curve veloci e rettilinei. Setup equilibrato necessario."
            },
            {
                id: "suzuka",
                ...
                elevation: "medium",
                bumps: 2,
                description: "Figura a 8 unica. Richiede bilanciamento aerodinamico perfetto."
            },
            {
                id: "nurburgring",
                ...
                elevation: "extreme",
                bumps: 5,
                description: "Inferno Verde. 20km di pura adrenalina. Sospensioni alte obbligatorie."
            },
            {
                id: "laguna_seca",
                name: "Laguna Seca",
                ...
                elevation: "high",
                bumps: 3,
                description: "Famoso per il Corkscrew. Elevation estrema e curve cieche."
            },
            {
                id: "imola",
                ...
                elevation: "medium",
                bumps: 2,
                description: "Circuito tecnico e veloce. Richiede aggressività in frenata."
            }
        ];
    ...
    CIRCUIT_PATHS: {
        // Spa-Francorchamps (Belgio) - Celebre per Eau Rouge
        'spa': {
        ...
        // Monaco - Circuito cittadino strettissimo
        'monaco': {
        ...
        // Silverstone - Mix di curve veloci
        'silverstone': {
    ...
    generateCircuitPath(circuit) {
        const width = 400;  // Aumentato da 300
        const height = 280; // Aumentato da 200
        ...
        if (!circuitData) {
            ...
            return {
                path: 'M 200 70 Q 330 70, 330 200 Q 330 330, 200 330 Q 70 330, 70 200 Q 70 70, 200 70 Z',
                width,
                height
            };
        }
        
        // Scala il path per le nuove dimensioni
        const scaleFactor = 1.33; // 400/300
        const scaledPath = circuitData.path.replace(/(\d+\.?\d*)/g, (match) => {
